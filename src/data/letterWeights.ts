...
// Higher weight = more likely to be selected (easier letter)
// Higher multiplier = more points (harder letter)
...
// Hardcore mode includes only hard letters
export const HARDCORE_LETTERS = ALL_LETTERS.filter(
  l => LETTER_CONFIG[l].difficulty === 'hard'
);

// Select a random letter using weighted probability
