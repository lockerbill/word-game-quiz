...
export class LeaderboardController {
  ...
  @ApiOperation({
    ...
    description:
      'Top scores across all time. Redis-cached for 60s. Registered users only.',
  })
  @ApiQuery({ name: 'limit', required: false, example: 100 })
  @ApiResponse({
    status: 200,
    description: 'Array of ranked leaderboard entries',
  })
  ...
  @ApiOperation({
    ...
    description: 'Top scores from the last 7 days. Redis-cached for 60s.',
  })
  @ApiQuery({ name: 'limit', required: false, example: 100 })
  @ApiResponse({
    status: 200,
  ...
  @Get('daily')
  @ApiOperation({
    summary: 'Daily challenge leaderboard',
    description:
      "Top scores from today's daily challenge. Redis-cached for 30s.",
  })
  @ApiQuery({ name: 'limit', required: false, example: 100 })
  @ApiResponse({
    status: 200,
